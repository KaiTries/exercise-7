...
int main() {
    ...
    const std::vector<double> alphas = {0.8, 1, 1.2, 1.4, 1.6, 1.8, 2};
    const std::vector<double> betas = {1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5};
    const std::vector<double> rhos = {0.3, 0.5, 0.7, 0.9};
